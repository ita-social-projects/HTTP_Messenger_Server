...
RequestSendMessages::RequestSendMessages(IDatabase* db,AnswerContainerInterface* answercontainer, const ISXModel::Message& message) : IRequests(db, answercontainer), message(message)
{
