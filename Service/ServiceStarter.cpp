...
SERVICE_STATUS_HANDLE ServiceStarter::g_StatusHandle = NULL;
...
VOID WINAPI ServiceStarter::ServiceMain(DWORD argc, LPTSTR* argv)
{
    ...
    g_StatusHandle = RegisterServiceCtrlHandler(SERVICE_NAME, ServiceStarter::ServiceCtrlHandler);
    ...
    HANDLE hThread = CreateThread(NULL, 0, ServiceStarter::ServiceWorkerThread, NULL, 0, NULL);
...
VOID WINAPI ServiceStarter::ServiceCtrlHandler(DWORD CtrlCode)
{
    switch (CtrlCode)
    {
...
DWORD WINAPI ServiceStarter::ServiceWorkerThread(LPVOID lpParam)
{
